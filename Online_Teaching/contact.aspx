<%@ Page Title="" Language="C#" MasterPageFile="~/Index.Master" AutoEventWireup="true" CodeBehind="contact.aspx.cs" Inherits="ELearning1.contact" %>
 ...
 <body class='body'>
   ...
   <asp:TextBox ID="txtName" runat="server"/>
    ...
    <tr>
     ...
     <div>
    <marquee> <h1>Contact No: 7558384244 , 9422085308      Email: pragati.nimbalkar@iccs.ac.in , dipali.bade@iccs.ac.in</h1></marquee>
     </div>
